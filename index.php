...
<section>
  <nav class="bg-white border-gray-200">
    <div class="logo max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="./image/logo4.png" class="" alt="Flowbite Logo" />
      </a>
    ...
    <section class="">
        <div class="header">
            ...
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-800 md:text-5xl lg:text-6xl">Custom Shoes Made Just for You</h1>
            <p class="my-4 text-lg text-gray-500"> At ShoeVibes, we believe that footwear is more than just a necessity it’s a statement, an extension of your personality, and a way to stand out. </p>
            </div>
