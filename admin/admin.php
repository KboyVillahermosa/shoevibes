    ...
    <section class="admin-header p-4 sm:ml-64">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
                <thead
                    class="name-header text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr
                            class="name border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
